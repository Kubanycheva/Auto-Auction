    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_role', models.CharField(choices=[('Администратор', 'Administratot'), ('Продавец', 'Salesman'), ('Покупатель', 'Buyer')], default='Administrator', max_length=32)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('auction', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='auction', to='auction_app.auction')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('car_name', models.CharField(blank=True, max_length=32, null=True)),
                ('year', models.PositiveSmallIntegerField()),
                ('fuel_type', models.CharField(blank=True, max_length=32, null=True, verbose_name='тип топлива')),
                ...
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='auction_app.category')),
            ],
        ),
        migrations.CreateModel(
            name='Brand',
            fields=[
                ...
                ('brand', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='brand', to='auction_app.car')),
            ],
        ),
        migrations.AddField(
            model_name='auction',
            name='car',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='car', to='auction_app.car'),
        ),
        migrations.CreateModel(
            name='FeedBack',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('model', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='model', to='auction_app.car')),
            ],
        ),
    ]
